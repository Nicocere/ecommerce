...
return ( 
    ...
    <div className={estilos.contacto}>
        <h3>Contactanos</h3>
        <a href="tel:+54 9 11 4788 9185" className="contacto-tel"><i className="fa-solid fa-phone"></i> +54 9 11 4788 9185</a>
        
        <a href="mailto:regalosflores25@gmail.com" className="contacto-mail"><i className="fa-solid fa-envelope"></i>Regalosflores25@gmail.com </a>
